...
class DataAndStatisticsModel extends OBFModel
{
  ...
  {
    $this->db->query('SELECT countries.name as name,count(*) as count,sum(duration) as duration
        FROM media
        LEFT JOIN countries ON media.country=countries.country_id
        GROUP BY media.country ORDER BY count DESC, duration DESC');
  ...
  {
    $this->db->query('SELECT languages.ref_name as name,count(*) as count,sum(duration) as duration
        FROM media
        LEFT JOIN languages ON media.language=languages.language_id
        GROUP BY media.language ORDER BY count DESC, duration DESC');
